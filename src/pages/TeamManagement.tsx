...
import { Plus, Edit, Users, Shield, UserCheck, UserX, Mail, Clock, X, RefreshCw, Trash2 } from 'lucide-react';
...
const TeamManagement = () => {
  ...
  const { canManageTeam } = useModulePermissions();
  ...
  return (
    <DashboardLayout>
      <PermissionGate module="team_management" permission="read">
        <div className="min-h-screen bg-gray-50 p-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex justify-between items-center mb-8">
              ...
              <PermissionGate module="team_management" permission="create" showError={false}>
                <Button
            ...
            {invitations.length > 0 && (
              <PermissionGate module="team_management" permission="update" showError={false}>
                      ...
                      <tbody>
                        {users.map((user) => (
                          <tr key={user.id} className="border-b border-gray-100 hover:bg-gray-50">
                            ...
                            <td className="py-4 px-4">
                              <PermissionGate module="team_management" permission="update" showError={false}
                                fallback={getStatusBadge(user.status)}
                              >
                                <Select
                                  value={user.status}
                            ...
                            <td className="py-4 px-4">
                              <div className="flex items-center space-x-2">
                                ...
                                <PermissionGate module="team_management" permission="delete" showError={false}>
                                  {user.role !== 'owner' && (
                                    <Button
                                      variant="outline"
                                      size="sm"
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  Esta ação não pode ser desfeita e todas as permissões do usuário serão removidas.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
