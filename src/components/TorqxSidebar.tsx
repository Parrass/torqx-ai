  ...
  return (
    <Sidebar>
      <SidebarBody>
        ...
        <div className="border-t border-gray-200 dark:border-torqx-primary-light pt-3 mt-4">
          {/* User Info */}
          <div className="flex items-center gap-2 px-2 mb-2 min-h-[40px]">
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-2 py-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors text-red-600 dark:text-red-400 min-h-[40px]"
          >
